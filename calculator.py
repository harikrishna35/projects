...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # Subtraction button
        self.Sub = Button(self, bg = "#98DBC6", bd = 12,
        text = "-",  padx = 33, pady = 25, font = ("Helvetica", 20, "bold"),
        command = lambda : self.buttonClick("-"))
        self.Sub.grid(row = 3, column = 3,sticky = W)

        # Multiplication button
        self.mul = Button(self, bg = "#98DBC6", bd = 12,
        text = "*",  padx = 33, pady = 25, font = ("Helvetica", 20, "bold"),
        command = lambda : self.buttonClick("*"))
        self.mul.grid(row = 4, column = 3,sticky = W)

        # Division button
        self.Div = Button(self, bg = "#98DBC6", bd = 12,
        text = "/",  padx = 33, pady = 25, font = ("Helvetica", 20, "bold"),
        command = lambda : self.buttonClick("/"))
        self.Div.grid(row = 5, column = 3,sticky = W)
...
calculator=Tk()
calculator.title("Calculator")  #table title
app=Application(calculator)     #connecting to class
calculator.resizable(width=False, height=False)    #to make window fixed
